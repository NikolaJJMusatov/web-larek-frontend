...
При проектировании использовался шаблон **Model-View-Presenter**. Взаимодействие компонентов осуществляет брокер событий. В роли презентера выступает код описанный в основном скрипте приложения.  

Цель работы заключалась: задокументировать архитектуру проекта, реализовать работу интернет-магазина. 

Стек технологий: HTML5, SCSS, TypeScript.

### В ходе работы были выполнены следующие задачи:  
:heavy_check_mark:	с помощью TypeScript была реализована вся функциональность  

:heavy_check_mark:	код приложения разделён на слои, выполняющие определённые задачи  

:heavy_check_mark:	типы и интерфейсы соответствуют тем структурам и данным, которые описаны в документации  
...
Проект доступен на [**GitHub Pages**](https://nikolajjmusatov.github.io/web-larek-frontend/).
### Установка и запуск
Создайте `.env файл` из `.env.production`  
